...
public class CarsDao {
    ...
    /** Добавление машины */
    public void addCarsTable(String brand, String model, String numberPlate, java.sql.Date dateOfCreate) {
        // language=SQL
    ...
    public CarsDto selectCarForIdCarsTable(int id) {
        // language=SQL
        ...
        try (Connection connection = Config.getConnection();
            ...
            if (resultSet.next()) {
                ...
                carDto = new CarsDto(id, brand,model, numberPlate, dateOfCreate);
            }
    ...
    /** Получение List<Car> */
    public List<CarsDto> getListOfCarCarsTable() {
        ...
        try (Connection connection = Config.getConnection();
            ...
            while (resultSet.next()) {
                ...
                cars.add(new CarsDto(id, brand, model, numberPlate, dateOfCreate));
            }
            return cars;
        } catch (SQLException e) {
